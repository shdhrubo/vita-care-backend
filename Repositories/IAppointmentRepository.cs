...
namespace vita_care.Repositories
{
    public interface IAppointmentRepository
    {
        ...
        Task<(List<Appointment> Items, long TotalCount)> GetPaginatedByCreatorEmailAsync(string creatorEmail, int pageNumber, int pageSize, CancellationToken cancellationToken);
